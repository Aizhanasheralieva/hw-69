...
import {
  fetchSuggestions,
  fetchTVShowDetailedInfo,
} from "../thunks/TVShows/TvShowsThunks.ts";
...
export const selectFetchShowLoading = (state: RootState) =>
  state.TVShows.loadings.showsFetching;
export const chosenFetchShowLoading = (state: RootState) =>
  state.TVShows.loadings.showsFetching;
